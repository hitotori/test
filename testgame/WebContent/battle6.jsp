...
<body>
<script type="text/javascript" src= "./js/battle6.js"></script>
...
<!-- 			//偽用 -->
		...
		<div class="box">
			<img src="img/business_man_macho.png" />
		</div>
...
<s:hidden id="ecp" name="ecp" value=""/>
		...
		<div class="logbox">
		<a href='<s:url action="Battle6Action" />' class="log">
