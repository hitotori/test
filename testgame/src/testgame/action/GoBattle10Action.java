...
import testgame.dao.GoBattle10DAO;
import testgame.dto.BattleDTO;

public class GoBattle10Action extends ActionSupport implements SessionAware{
	...
	private GoBattle10DAO dao=new GoBattle10DAO();
