...
//		String charactersql="SELECT * FROM enemy_transaction WHERE enemy_name=パンダ ,enemy_hp=50, enemy_attack=18 ,enemy_defense=20,enemy_experiencepoint=10";
		String enemysql="SELECT * FROM enemy_transaction WHERE id=10";
		try {
