...
//		String charactersql="SELECT * FROM enemy_transaction WHERE enemy_name=森の賢人;
		String enemysql="SELECT * FROM enemy_transaction WHERE id=3";
		try {
